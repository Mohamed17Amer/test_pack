...
final getItAuth = GetIt.instance;
...
void setupServiceLocator() {
  ...
  getIt.registerSingleton<PostsRepoImpl>(
    PostsRepoImpl(
      localDataSource: LocalDataSourceImpl(HiveServicesForPosts()),
      remoteDataSource: RemoteDataSourceImpl(
        getIt.get<ApiService>(),
        HiveServicesForPosts(),
      ),
      hiveServices: HiveServicesForPosts(),
    ),
  );

 // getItAuth.registerSingleton<>(instance)
}
